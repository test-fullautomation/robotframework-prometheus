...
Prometheus Set Values Execution I-741-B
   rf.extensions.pretty_print    ==== Execution: 'I-741-B' / 'Suite-B-Test-01' : Room_1 / Testbench 2

   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_unknown    labels=Room_1;Testbench 2;Suite-B-Test-01;UNKNOWN

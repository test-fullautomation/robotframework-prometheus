...
Prometheus Set Values Execution I-148-B
   rf.extensions.pretty_print    ==== Execution: 'I-148-B' / 'Suite-B-Test-08' : Room_1 / Testbench 2

   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_passed    labels=Room_1;Testbench 2;Suite-B-Test-08;PASSED

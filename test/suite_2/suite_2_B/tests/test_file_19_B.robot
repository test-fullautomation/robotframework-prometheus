...
Prometheus Set Values Execution I-19-B
   rf.extensions.pretty_print    ==== Execution: 'I-19-B' / 'Suite-B-Test-09' : Room_1 / Testbench 2

   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_passed    labels=Room_1;Testbench 2;Suite-B-Test-09;PASSED
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_passed    value=2    labels=Room_1;Testbench 2;Suite-B-Test-09;PASSED
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ...
   ${success}    ${result}    rf.prometheus_interface.set_info    name=overview    info=test_name:Suite-B-Test-09;test_result:PASSED;file_number:F-19    labels=Room_1;Testbench 2

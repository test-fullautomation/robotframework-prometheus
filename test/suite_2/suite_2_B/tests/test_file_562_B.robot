...
Prometheus Set Values Execution I-562-B
   rf.extensions.pretty_print    ==== Execution: 'I-562-B' / 'Suite-B-Test-02' : Room_1 / Testbench 2

   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_passed    labels=Room_1;Testbench 2;Suite-B-Test-02;PASSED

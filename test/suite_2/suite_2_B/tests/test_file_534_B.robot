...
Prometheus Set Values Execution I-534-B
   rf.extensions.pretty_print    ==== Execution: 'I-534-B' / 'Suite-B-Test-04' : Room_1 / Testbench 2

   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_unknown    labels=Room_1;Testbench 2;Suite-B-Test-04;UNKNOWN

...
Prometheus Set Values Execution I-12-B
   ...
   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_unknown    value=2    labels=Room_1;Testbench 2;Suite-B-Test-02;UNKNOWN
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ...
   ${success}    ${result}    rf.prometheus_interface.set_info    name=overview    info=test_name:Suite-B-Test-02;test_result:UNKNOWN;file_number:F-12    labels=Room_1;Testbench 2

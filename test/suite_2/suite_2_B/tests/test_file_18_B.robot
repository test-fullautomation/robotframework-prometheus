...
Prometheus Set Values Execution I-18-B
   ...
   ${success}    ${result}    rf.prometheus_interface.set_info    name=overview    info=test_name:Suite-B-Test-08;test_result:UNKNOWN;file_number:F-18    labels=Room_1;Testbench 2

...
Prometheus Set Values Execution I-17-B
   rf.extensions.pretty_print    ==== Execution: 'I-17-B' / 'Suite-B-Test-07' : Room_1 / Testbench 2

   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_failed    labels=Room_1;Testbench 2;Suite-B-Test-07;FAILED
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_failed    value=2    labels=Room_1;Testbench 2;Suite-B-Test-07;FAILED
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}

   ${success}    ${result}    rf.prometheus_interface.set_gauge    name=beats_per_minute    value=185    labels=Room_1;Testbench 2
   ...
   ${success}    ${result}    rf.prometheus_interface.set_info    name=overview    info=test_name:Suite-B-Test-07;test_result:FAILED;file_number:F-17    labels=Room_1;Testbench 2

...
Prometheus Set Values Execution I-03-A
   ...
   ${success}    ${result}    rf.prometheus_interface.set_info    name=overview    info=test_name:Suite-A-Test-03;test_result:UNKNOWN;file_number:F-3    labels=Room_1;Testbench 1

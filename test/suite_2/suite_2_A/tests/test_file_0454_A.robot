...
Prometheus Set Values Execution I-0454-A
   rf.extensions.pretty_print    === Execution: 'I-0454-A' / 'Suite-A-Test-04' : Room_1 / Testbench 1
   rf.extensions.pretty_print    >>> inc 'num_passed' / beats_per_minute = 140 / testresult = PASSED

   Inc Counter    name=num_passed    labels=Room_1;Testbench 1;Suite-A-Test-04;PASSED

...
Prometheus Set Values Execution I-08-A
   rf.extensions.pretty_print    ==== Execution: 'I-08-A' / 'Suite-A-Test-08' : Room_1 / Testbench 1

   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_failed    labels=Room_1;Testbench 1;Suite-A-Test-08;FAILED
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_failed    value=2    labels=Room_1;Testbench 1;Suite-A-Test-08;FAILED
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ...
   ${success}    ${result}    rf.prometheus_interface.set_info    name=overview    info=test_name:Suite-A-Test-08;test_result:FAILED;file_number:F-8    labels=Room_1;Testbench 1

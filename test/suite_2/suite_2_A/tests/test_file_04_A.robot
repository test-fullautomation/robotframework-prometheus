...
Prometheus Set Values Execution I-04-A
   rf.extensions.pretty_print    ==== Execution: 'I-04-A' / 'Suite-A-Test-04' : Room_1 / Testbench 1

   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_passed    labels=Room_1;Testbench 1;Suite-A-Test-04;PASSED
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_passed    value=2    labels=Room_1;Testbench 1;Suite-A-Test-04;PASSED
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ...
   ${success}    ${result}    rf.prometheus_interface.set_info    name=overview    info=test_name:Suite-A-Test-04;test_result:PASSED;file_number:F-4    labels=Room_1;Testbench 1

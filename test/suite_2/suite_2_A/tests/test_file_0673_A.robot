...
Prometheus Set Values Execution I-0673-A
   rf.extensions.pretty_print    === Execution: 'I-0673-A' / 'Suite-A-Test-03' : Room_1 / Testbench 1
   rf.extensions.pretty_print    >>> inc 'num_passed' / beats_per_minute = 10 / testresult = PASSED

   Inc Counter    name=num_passed    labels=Room_1;Testbench 1;Suite-A-Test-03;PASSED

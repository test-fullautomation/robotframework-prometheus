...
Prometheus Set Values Execution I-06-A
   rf.extensions.pretty_print    ==== Execution: 'I-06-A' / 'Suite-A-Test-06' : Room_1 / Testbench 1

   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_unknown    labels=Room_1;Testbench 1;Suite-A-Test-06;UNKNOWN
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_unknown    value=2    labels=Room_1;Testbench 1;Suite-A-Test-06;UNKNOWN
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ...
   ${success}    ${result}    rf.prometheus_interface.set_info    name=overview    info=test_name:Suite-A-Test-06;test_result:UNKNOWN;file_number:F-6    labels=Room_1;Testbench 1
   rf.extensions.pretty_print    [set_info (overview)] (${success}) : ${result}

   ${success}    ${result}    rf.prometheus_interface.set_info    name=lighting    info=lighting:nightlight    labels=Room_1;Testbench 1

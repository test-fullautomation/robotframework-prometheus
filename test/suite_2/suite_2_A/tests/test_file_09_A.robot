...
Prometheus Set Values Execution I-09-A
   rf.extensions.pretty_print    ==== Execution: 'I-09-A' / 'Suite-A-Test-09' : Room_1 / Testbench 1

   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_unknown    labels=Room_1;Testbench 1;Suite-A-Test-09;UNKNOWN
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ${success}    ${result}    rf.prometheus_interface.inc_counter    name=num_unknown    value=2    labels=Room_1;Testbench 1;Suite-A-Test-09;UNKNOWN
   rf.extensions.pretty_print    [inc_counter] (${success}) : ${result}
   ...
   ${success}    ${result}    rf.prometheus_interface.set_info    name=overview    info=test_name:Suite-A-Test-09;test_result:UNKNOWN;file_number:F-9    labels=Room_1;Testbench 1

...
class CRepositoryConfig():
    ...
    def __init__(self, sCalledBy=None):
        ...
        self.__dictRepositoryConfig['PACKAGE_DATA'] = package_data.get(self.__dictRepositoryConfig['IMPORTNAME'], [])
    ...
    def __InitConfig(self):
        ...
        if sPlatformSystem == "Windows":
            sInstalledPackageFolder = f"{sPythonPath}/Lib/site-packages/" + self.__dictRepositoryConfig['IMPORTNAME']
        elif sPlatformSystem == "Linux":
            sInstalledPackageFolder = f"{sPythonPath}/../lib/python3.9/site-packages/" + self.__dictRepositoryConfig['IMPORTNAME']
        else:
            bSuccess = False
